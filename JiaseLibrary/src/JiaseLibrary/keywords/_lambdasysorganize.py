...
class _LambdaSysOrganizeKeywords():
    ...
    # 根据机构名称查询机构id
    def _query_branchId(self,branch_name):
    ...
    # 根据部门名称查询部门id
    def _query_deptId(self,branchId,dept_name):
    ...
    # 根据岗位名称查询岗位id
    def _query_positionId(self,branchId,position_name):
    ...
    # 根据角色名称查询角色id
    def _query_roleId(self,deptId,role_name):
